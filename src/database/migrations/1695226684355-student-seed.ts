...
export class StudentSeed1695226684355 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        for (const student of students) {
            student.which.split(", ").forEach((w: any) => {
                switch (w) {
                    case "Computer Application Assistant - NVQ Level 3":
                        student.comAppAssist3 = true;
                        break;
                    case "ICT Technician - NVQ Level 4":
                        student.ict4 = true;
                        break;
                    case "Computer Hardware Technician - NVQ Level 4":
                        student.hardware4 = true;
                        break;
                    case "Computer Network Technician - NVQ Level 4":
                        student.network4 = true;
                        break;
                    case "Computer Graphic Designer - NVQ Level 4":
                        student.graphic4 = true;
                        break;
                    case "IT Supporter - NVQ Level 4":
                        student.icSupporter4 = true;
                        break;
                    case "Software Developer - NVQ Level 4":
                        student.softwareDev4 = true;
                        break;
                    default:
                        student.followOther = true;
                        student.followedOther = w;
                }
            });
            delete student.which;

            student.doneIct.split(", ").forEach((t: any) => {
                if (t === "Yes. O/L ICT" && t === "Yes. A/L ICT") {
                    student.doneIct = DoneICT.BOTH;
                } else if (t === "Yes. O/L ICT") {
                    student.doneIct = DoneICT.OL;
                } else if (t === "Yes. A/L ICT") {
                    student.doneIct = DoneICT.AL;
                } else {
                    student.doneIct = DoneICT.NONE;
                }
            });

            student.alPassed = student.alPassed === "Yes";
            ...
            const dto: Partial<UserEntity> = {
                ...
                email: student.email.replace(/\s/g, "").toLowerCase(),
                cot: student.cot,
                cotOther: student.cot,
                olMaths: student.olMaths,
                olScience: student.olScience,
                olEnglish: student.olEnglish,
                alStream: student.alStream,
                alOther: student.alStream,
                alPassed: student.alPassed,
                doneIct: student.doneIct,
                comAppAssist3: student.comAppAssist3,
                ict4: student.ict4,
                hardware4: student.hardware4,
                network4: student.network4,
                graphic4: student.graphic4,
                icSupporter4: student.icSupporter4,
                softwareDev4: student.softwareDev4,
                followOther: student.followOther,
                followedOther: student.followedOther,
            };
